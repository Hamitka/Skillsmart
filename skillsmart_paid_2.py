...
print()
print(recursion_max([1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4]))
print(recursion_second_max([1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4]))
print(recursion_second_max([1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4, 10]))
print(recursion_i_max([1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4], 3))
print(recursion_i_max([1, 2, 3, 4, 5, 6, 7, 8, 9, 8, 7, 6, 5, 4], 6))
